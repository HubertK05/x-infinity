...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.generate_definitions_button = QPushButton(self.centralwidget)
        self.generate_definitions_button.setObjectName(u"generate_definitions_button")

        self.horizontalLayout_2.addWidget(self.generate_definitions_button)
        ...
        self.generate_wordlist_button = QPushButton(self.centralwidget)
        ...
        self.menubar.setGeometry(QRect(0, 0, 923, 20))
